// from example project: https://github.com/relayjs/relay-examples/blob/main/issue-tracker-next-v13/src/relay/useSerializablePreloadedQuery.ts
...
import { responseCache } from "./enviroment";
...
export default function useSerializableQuery<
